...
bool TetrisVector::readFromFile(string fileName)
{
    ifstream save_file;
    ...
    save_file.close();
    cout << "\nGame board loaded successfully\n";
...
TetrisVector& TetrisVector::operator =(const TetrisVector &other)// copy assignment operator
{
    int i, j;
    if (this == &other)
        return *this;
...
TetrisVector::TetrisVector(int len_of_row, int len_of_clmn)
{
...
void TetrisVector::animate(const TetrisVector& temp, int i, int j)
{
    int len, a; 
...
void TetrisVector::operator += (const Tetromino& obj)
{
    ...
    {
        cout << "number moves: " << numberOfMoves();
        cout << "Game over!";
        exit(1);
    }
}
...
void TetrisVector::move(char move_direction, int move_count, const TetrisVector& temp)
{
...
bool TetrisVector::isvalid_place(const Tetromino& other, int i, int j)
{
...
void TetrisVector::add(const Tetromino& other, int i, int j)
{
